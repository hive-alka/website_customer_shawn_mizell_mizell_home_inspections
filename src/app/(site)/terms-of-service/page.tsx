    ...
    <>
      ...
      <div className='prose prose-lg max-w-none'>
        <div className='bg-white rounded-2xl p-8 border border-black/10 shadow-lg'>
          ...
          <section className='mb-8'>
            <h2 className='text-2xl font-semibold text-black mb-4'>3. Scheduling and Payment</h2>
            <p className='text-black/70 mb-4'>
          ...
          <section className='mb-8'>
            <h2 className='text-2xl font-semibold text-black mb-4'>4. Client Responsibilities</h2>
            <ul className='list-disc pl-6 text-black/70 space-y-2'>
          ...
          <section className='mb-8'>
            <h2 className='text-2xl font-semibold text-black mb-4'>5. Limitations of Inspection</h2>
            <p className='text-black/70 mb-4'>
          ...
          <section className='mb-8'>
            <h2 className='text-2xl font-semibold text-black mb-4'>6. Inspection Reports</h2>
            <p className='text-black/70 mb-4'>
          ...
          <section className='mb-8'>
            <h2 className='text-2xl font-semibold text-black mb-4'>8. Recommendations</h2>
            <p className='text-black/70 mb-4'>
          ...
          <section className='mb-8'>
            <h2 className='text-2xl font-semibold text-black mb-4'>10. Licensing Information</h2>
            <p className='text-black/70 mb-4'>
          ...
          <section className='mb-8'>
            ...
            <div className='bg-dark/5 p-6 rounded-xl'>
              <p className='text-black font-semibold mb-3'>Mizell Home Inspections LLC</p>
              <p className='text-black/70'>687 Harvard St., Brooksville, FL 34601</p>
              <p className='text-black/70'>Phone: <a href='tel:352-652-0259' className='text-primary hover:underline'>352-652-0259</a></p>
              <p className='text-black/70'>Email: <a href='mailto:shawn@mizellhomeinspections.com' className='text-primary hover:underline'>shawn@mizellhomeinspections.com</a></p>
            </div>
          </section>
