    ...
    <>
      ...
      <div className='prose prose-lg max-w-none'>
        <div className='bg-white rounded-2xl p-8 border border-black/10 shadow-lg'>
          ...
          <section className='mb-8'>
            <h2 className='text-2xl font-semibold text-black mb-4'>4. Information Sharing</h2>
            <p className='text-black/70 mb-4'>
          ...
          <section className='mb-8'>
            <h2 className='text-2xl font-semibold text-black mb-4'>8. Cookies and Tracking</h2>
            <p className='text-black/70 mb-4'>
          ...
          <section className='mb-8'>
            <h2 className='text-2xl font-semibold text-black mb-4'>9. Third-Party Links</h2>
            <p className='text-black/70 mb-4'>
          ...
          <section className='mb-0'>
            <h2 className='text-2xl font-semibold text-black mb-4'>Copyright Notice</h2>
